...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="py-6"><nav><div class="container flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full"><div class="md:ml-16 logo"><svg height="20" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 312.1 312.1" style="enable-background:new 0 0 312.1 312.1;" xml:space="preserve"><g><g><path d="M184.49,60.81L184.49,60.81L184.49,60.81l-72.13-29.52l-51.5,74.39v0.01h-0.01l34.56,134.86l0.03-0.01v0.01l61.77,34.8
         l93.3-86.89l0.73-0.68L184.49,60.81z M97.67,238.8l-31.9-124.47l88.86,156.56L97.67,238.8z M155.49,267.09L63.95,105.81
         l49.36-71.3l68.32,27.96L155.49,267.09z M157.58,271.43l26.33-206.09l64.08,121.88L157.58,271.43z"></path><path d="M157.28,275.96l-0.32-0.18l-61.6-34.7l-0.28,0.08l-0.09-0.29l-0.26-0.14l0.15-0.24L60.37,105.82l-0.09-0.16l0.04-0.05
...
<section class="container mt-16 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full"><div class="flex flex-wrap lg:ml-20 md:justify-start max-w-xl mt-0 md:my-36"><h1 class="font-bold text-5xl md:text-6xl lg:text-7xl">Web technologies <br>simplified</h1>
          ...
          <button class="text-mainff px-8 p-2 mt-4 rounded-lg bg-mainblack">Book a free consultation
          </button></div>
      <div><img src="hero.svg" class="md:h-80" alt="mockup"></div></section>`;
});
export {
  Page as default
};
